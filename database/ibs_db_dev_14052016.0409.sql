...
INSERT INTO `driver_destination` (`dd_id`, `u_id`, `lo_id_from`, `lo_id_to`, `dd_status`) VALUES
(1, 2, 1, 2, 1),
(2, 2, 2, 1, 2),
(3, 2, 2, 3, 1),
(4, 3, 3, 2, 2);
...
(1, 2, '2.3089112, 102.3203475', 1),
(2, 3, '2.3089501, 102.32031320000002', 1),
(3, 1, '2.3089291, 102.3203302', 1);
...
(1, 'UMAR MUKHTAR BIN HAMBARAN', 'M031210009', '123', 1, 1),
